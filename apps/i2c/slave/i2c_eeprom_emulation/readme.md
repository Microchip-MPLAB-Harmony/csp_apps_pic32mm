...
To download or clone this application from Github, go to the [top level of the repository](https://github.com/Microchip-MPLAB-Harmony/csp_apps_pic32mm) and click
...
- On MikroBus header J12, connect I2C SDA and I2C SCL lines with the corresponding SDA and SCL lines of the I2C master
